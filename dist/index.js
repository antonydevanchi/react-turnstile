...
function Turnstile({ id, className, style, sitekey, action, cData, theme, size, tabIndex, responseField, responseFieldName, autoResetOnExpire, onVerify, onLoad, onError, onExpire, onTimeout, }) {
